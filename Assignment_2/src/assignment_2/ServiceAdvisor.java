 ...
 * after we get to cover this in class. This is a simple little app, but it
 * requires doing some logic testing. Here's the requirement: I want you to
 * write a program that is a "Service Advisor" for a car. You type in the
 * mileage of your car, and it will tell you about any service that is required
 * within the next two thousand miles.
 * 
 * I want you to use the JOptionPane dialog boxes, rather than console I/O to
 * get input and display output. Your output might consist of several lines,
 * depending on what's needed.
 * 
 * Here's the data: Oil Change - every 6000 miles Tire Rotation - every 8000
 * miles Tire Condition Check - every 5000 miles Tire Replacement - every 41000
 * miles Air Filter Replacement - every 14000 miles Spark Plug Replacement -
 * every 32000 miles Timing Belt Replacement - every 65000 miles Cabin Air
 * Filter Replacement - every 22000 miles
 * 
 * You should be able to enter the current mileage of your car, and have it list
 * everything that is due within the next 2000 miles. A suggestion for telling
 * if you're within that mileage? Use the "Modulo" operator, like car mileage
 * modulo spark plug interval, if that remainder is 2000 or less, then you need
 * to print this out. If it isn't, then skip it.
 * 
 * Be sure you test this with high mileage values - me, I'm used to getting my
 * money's worth out of a car, so I've run Hyundais well past the 200,000 mile
 * mark and had them going strong.
 * 
 * When you have this working, do like you did the last program, copy/past the
 * java file, and attach it here. This is due on Monday, February 20th.
